...
| **Сервис**          | **Пиковая нагрузка в RPS** | **Пиковая нагрузка в GBit/s** | **RAM на экземпляр** | **CPU на экземпляр**  | **Количество серверов** | **Общая RAM** | **Общее количество подов** |
|---------------------|----------------------------|-------------------------------|-----------------------|-----------------------|---------------------------|----------------------------|-------------------------------|
| **auth**            | 20                         | < 0.1                         | 2048 МБ                | 2 CPU               | 4                          | 8 ГБ           | 8                             |
| **profile**         | 2                          | < 0.1                         | 2048 МБ                | 2 CPU               | 4                          | 8 ГБ           | 8                             |
| **content**         | 24,900                     | 947                           | 8 ГБ                 | 4 CPU                | 50                         | 4.8 ТБ         | 250                           |
| **file**            | 24,100                     | 965                           | 64 ГБ                 | 8 CPU                 | 10                         | 640 ГБ         | 30                            |
| **recommend**       | 25,000                     | 5                             | 8 ГБ                  | 8 CPU                 | 20                         | 80 ГБ          | 40                            |
| **statistic**       | 1,000                      | 1                             | 1 ГБ                  | 2 CPU               | 10                          | 4 ГБ           | 15                             |
| **contentControl**  | 100                        | < 0.1                         | 1 ГБ                  | 2 CPU               | 6                          | 4 ГБ           | 12                             |
| **comment**         | 3                          | < 0.1                         | 2048 МБ                | 2 CPU               | 4                          | 8 ГБ           | 8                             |
| **search**          | 250                        | 12                            | 4 ГБ                  | 4 CPU                 | 10                          | 16 ГБ          | 8                             |
| **favorite**        | 150                        | 4                             | 2 ГБ                  | 2 CPU                 | 5                          | 10 ГБ           | 10                             |
| **channel**         | 2                          | < 0.1                         | 2048 МБ                | 2 CPU               | 4                          | 8 ГБ           | 8                             |
