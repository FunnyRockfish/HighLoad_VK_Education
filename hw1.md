...
![Database ER diagram (crow's foot) - Page 1 (1)](https://github.com/user-attachments/assets/15f91f10-6b91-42d0-9303-f5ef9ebbcf29)
...
| **Таблица**             | **Описание**                                                                 | **БД**          |
|-------------------------|-------------------------------------------------------------------------------|----------------|
| `video`                 | Содержит информацию о видео (заголовок, описание, автор, форматы, метаданные). | **MongoDB**     |
