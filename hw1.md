...
- **Трафик и вес на сервере для короткого видео**: 
  - в разрещении 480p: **2 Мбит/с** (1 минута 45 секунд, 2000 битрейт) => на сервере займёт **26 МБ**[^6], После сжатия — **10 МБ**
  - в разрещении 240p: **1 Мбит/с** (1 минута 45 секунд, 1000 битрейт) => на сервере займёт **13 МБ**[^6], После сжатия — **5 МБ**
  - в разрещении 160p: **0,5 Мбит/с** (1 минута 45 секунд, 500 битрейт) => на сервере займёт **6 МБ**[^6], После сжатия — **3 МБ**
  
- **Трафик и вес на сервере для длинного видео в наилучшем разрешении**:
  - в разрещении 480p:**5 Мбит/с** (в среднем 4 часа, 5000 битрейт) – **9 ГБ**.
