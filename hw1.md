...
- **Трафик для короткого видео**: 
  - **0,1 Гбит/с** (1 минута 45 секунд, 1000 битрейт) – **13 МБ**[^6]. 
  - После сжатия — **5 МБ**.
...
### Сетевой трафик – обычный (70 Гбит/с):

| Действие                         | Скорость трафика                       |
|-----------------------------------|----------------------------------------|
| Загрузка видео пользователем      | 20 Гбит/с                              |
| Просмотр видео                    | 30 Гбит/с                              |
| Загрузка и подбор рекламы         | 10 Гбит/с                              |
| Загрузка статей                   | 3 Гбит/с                               |
| Загрузка превью статей и видео    | 7 Гбит/с                               |

### Сетевой трафик – пиковый (100 Гбит/с) [CTO Дзена](https://t.me/kondra2lp):

| Действие                         | Скорость трафика                       |
|-----------------------------------|----------------------------------------|
| Загрузка видео пользователем      | 30 Гбит/с                              |
| Просмотр видео                    | 40 Гбит/с                              |
| Загрузка и подбор рекламы         | 15 Гбит/с                              |
| Загрузка статей                   | 5 Гбит/с                               |
