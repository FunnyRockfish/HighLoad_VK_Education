...
| **Сервис**          | **Пиковая нагрузка в RPS** | **Пиковая нагрузка в GBit/s** | **RAM на экземпляр** | **Количество экземпляров** | **Общая RAM (примерно)** |
|---------------------|----------------------------|-------------------------------|-----------------------|----------------------------|--------------------------|
| **auth**            | 20                         | < 1                           | 2 ГБ                  | 4                          | 8 ГБ                     |
| **profile**         | 2                          | < 1                           | 2 ГБ                  | 4                          | 8 ГБ                     |
| **content**         | 24,900                     | 947                           | 128 ГБ                | 55                         | 7 ТБ                     |
| **file**            | 24,100                     | 965                           | 128 ГБ                | 6                          | 768 ГБ                   |
| **recommend**       | 25,000                     | 5                             | 4 ГБ                  | 6                          | 24 ГБ                    |
| **statistic**       | 1,000                      | 1                             | 2 ГБ                  | 4                          | 8 ГБ                     |
| **contentControl**  | 100                        | 5                             | 2 ГБ                  | 3                          | 6 ГБ                     |
| **comment**         | 1                          | 8                             | 2 ГБ                  | 3                          | 6 ГБ                     |
| **search**          | 250                        | 12                            | 4 ГБ                  | 3                          | 12 ГБ                    |
| **favorite**        | 150                        | 8                             | 2 ГБ                  | 3                          | 6 ГБ                     |
| **channel**         | 2                          | < 1                           | 2 ГБ                  | 3                          | 6 ГБ                     |

### Таблица 11.3: Графические процессоры (GPU) для ML в ДЗЕНе

| **Модель GPU**   | **Количество** | **Назначение**                                           | **Описание**                                                   |
|------------------|-----------------|-----------------------------------------------------------|----------------------------------------------------------------|
| **NVIDIA T4**    | 6               | Машинное обучение (ALS, CatBoost), NLP (BERT, T5), TTS    | Эффективны для инференса и обучения моделей средней сложности  |
| **NVIDIA A100**  | 2               | Обучение крупных моделей NLP и TTS                        | Высокая производительность для обучения больших моделей          |
| **NVIDIA V100**  | 1               | Специализированные задачи машинного обучения и обработки данных | Альтернативный вариант для высокопроизводительных задач             |
