...
| `user_statistic`        | Статистика просмотров пользователя (история видео и статей).                  | **ClickHouse**  | Эффективная аналитическая БД для отслеживания действий пользователей и построения отчетов. |
