...
|---------------|-------------------|----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------|
| CatBoost      | ML-библиотека     | Обучение моделей, ML                                    | Применяется для алгоритмов ранжирования, высокопроизводительная библиотека для градиентного бустинга на деревьях решений                                             | Локальные серверы или облачные сервисы, API       |
...
| T5            | LLM               | Написание и правка текстов, анализ и улучшение стиля    | LLM помогут пользователям быстрее создавать качественный контент. А ускорение создания письменного контента и улучшение его качества привлечёт новых пользователей и увеличит общее количество статей | Облачные платформы с GPU (AWS, Azure), Docker     |
